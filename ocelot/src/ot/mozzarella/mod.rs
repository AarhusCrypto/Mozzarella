...
pub const REG_MAIN_K: usize = 300; // TODO: remove this eventually, when cache works
//pub const REG_MAIN_T: usize = 1_319; // TODO: remove this eventually, when cache works
pub const REG_MAIN_T: usize = 8; // TODO: remove this eventually, when cache works
//const REG_MAIN_N: usize = 10_805_248;
pub const REG_MAIN_N: usize = 1024;
//pub const REG_MAIN_LOG_SPLEN: usize = 13;
//pub const REG_MAIN_SPLEN: usize = 1 << REG_MAIN_LOG_SPLEN;
pub const REG_MAIN_LOG_SPLEN: usize = 7;
pub const REG_MAIN_SPLEN: usize = 128;
